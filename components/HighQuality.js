  ...
  return (
    <div className="md:flex items-center pt-20 px-7 md:px-20">
      <div className="h-full">
        <Image src={vector} className="-mt-9 left-[3%] md:w-fit md:h-fit w-10 h-10 absolute" />
        ...
        <div className="grid grid-cols-2 gap-6 w-11/12 px-4 md:mt-4 mt-9">
            {items.map(item => <div className="bg-white px-3 md:px-5 flex rounded py-3">
      ...
      <div className="flex relative md:mt-0 mt-10">
        <div className="absolute top-14 md:top-28">
          <Image src={sub} className='md:w-fit md:h-fit w-40 object-contain h-20'/>
        </div>
        <Image src={img} />
      </div>
    </div>
